                                        ...
                                        <div class="card-body pt-0 pb-5">
                                            <div class="row my-2">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <label>
                                                        <select name="order-table_length" aria-controls="order-table"
                                                ...
                                                <div id="order-table_processing" class="dataTables_processing"
                                                    style="display: none;">
                                                    <span class="spinner-border w-15px h-15px text-muted align-middle me-2">
                                                ...
                                                <table id="order-table"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center px-4 py-3 sorting_disabled" rowspan="1"
                                                                colspan="1" style="width: 52px;" aria-label="Vendor">
