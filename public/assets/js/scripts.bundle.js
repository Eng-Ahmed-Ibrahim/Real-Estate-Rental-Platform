	...
	var handleThemeMode = function() {
		...
		if (checkLight) {
			checkLight.addEventListener("click", function() {
                ...
                document.querySelector(".notification_iccon").setAttribute("src", "/icons/Bell_white.png");
		...
		if (checkDark) {
			checkDark.addEventListener("click", function() {
                ...
                document.querySelector(".notification_iccon").setAttribute("src", "/icons/Bell_black.png");
			});
		}
